...
- Allocation visée : **risk parity / volatilité ciblée** — les poids égalisent la contribution au risque, pas le capital. Conséquence assumée : cela introduit une estimation de covariance, qui devient elle-même un objet à valider (elle peut sur-ajuster comme n'importe quel paramètre estimé) et non un calcul de plomberie.
