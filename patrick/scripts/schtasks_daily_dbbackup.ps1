...
Write-Output "  Retention                -> backup_db.py purge desormais automatiquement, apres chaque"
Write-Output "                             sauvegarde reussie, les fichiers patrick_backup_*.db de plus de"
Write-Output "                             30 jours dans --backup-dir (voir --retention-days, 0 pour"
Write-Output "                             desactiver) -- pas besoin de purge separee cote PowerShell."
