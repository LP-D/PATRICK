...
def test_build_config_dict_defaults_technical_lookbacks_when_form_omits_them():
    ...
    form = _minimal_form()
    config_dict, errors = forms.build_config_dict(form, target_symbol="^VIX", name="VIX_13")
    assert errors == []
...
def test_build_config_dict_rejects_zero_zscore_window():
    ...
    _config_dict, errors = forms.build_config_dict(form, target_symbol="^VIX", name="VIX_17")
...
def test_build_config_dict_rejects_ohlc_vol_window_below_two():
    ...
    _config_dict, errors = forms.build_config_dict(form, target_symbol="^VIX", name="VIX_18")
...
def test_build_config_dict_rejects_non_numeric_technical_lookback():
    ...
    _config_dict, errors = forms.build_config_dict(form, target_symbol="^VIX", name="VIX_19")
